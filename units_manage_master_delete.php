	...
	if ($role!="Coordinator" AND $role!="Teacher (Curriculum)") {
		...
		if ($ibPYPUnitMasterID=="" OR $gibbonSchoolYearID=="") {
			...
			if ($result->rowCount()!=1) {
				...
				$row=$result->fetch() ;
				?>
				<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/IB PYP/units_manage_master_deleteProcess.php?ibPYPUnitMasterID=$ibPYPUnitMasterID&gibbonSchoolYearID=$gibbonSchoolYearID" ?>">
					<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
						...
						<tr>
							<td> 
								<input name="ibPYPUnitMasterID" id="ibPYPUnitMasterID" value="<?php print $ibPYPUnitMasterID ?>" type="hidden">
