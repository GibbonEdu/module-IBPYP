...
if (isActionAccessible($guid, $connection2, '/modules/IB PYP/staff_manage_add.php') == false) {
    ...
    if (isset($_GET['editID'])) {
        $editLink = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/IB PYP/staff_manage_edit.php&ibPYPStaffTeachingID='.$_GET['editID'];
    }
    ...
    ?>
	<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL'].'/modules/IB PYP/staff_manage_addProcess.php' ?>">
