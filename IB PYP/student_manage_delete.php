...
if (isActionAccessible($guid, $connection2, "/modules/IB PYP/student_manage_delete.php")==FALSE) {
	...
	if ($ibPYPStudentID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/IB PYP/student_manage_deleteProcess.php?ibPYPStudentID=$ibPYPStudentID" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					<tr>
						<td> 
							<b>Are you sure you want to delete "<?php print formatName("", $row["preferredName"], $row["surname"], "Student", true, true) ?>" from the IB PYP programme?</b><br/>
					...
					<tr>
						<td> 
							<input name="ibPYPStudentID" id="ibPYPStudentID" value="<?php print $ibPYPStudentID ?>" type="hidden">
