...
if (isActionAccessible($guid, $connection2, '/modules/IB PYP/units_manage_working_edit.php') == false) {
    ...
    if ($ibPYPUnitWorkingID == '' or $gibbonSchoolYearID == '') { echo "<div class='error'>";
        ...
        if ($result->rowCount() != 1) {
            echo "<div class='error'>";
            echo 'The selected unit does not exist.';
            echo '</div>';
        } else {
            //Let's go!
            $row = $result->fetch();
				...
				<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL']."/modules/IB PYP/units_manage_working_editProcess.php?ibPYPUnitWorkingID=$ibPYPUnitWorkingID&gibbonSchoolYearID=$gibbonSchoolYearID" ?>">
					<table class='smallIntBorder' cellspacing='0' style="width: 100%;">
						...
						<tr class='break'>
							<td colspan=3>
								<div class='linkTop'>
									<a href='<?php echo $_SESSION[$guid]['absoluteURL'] ?>/index.php?q=/modules/IB PYP/units_manage_working_edit.php&ibPYPUnitWorkingID=<?php echo $ibPYPUnitWorkingID ?>&step=2&gibbonSchoolYearID=<?php echo $gibbonSchoolYearID ?>'>Jump to Reflection</a>
								</div>
				...
				<form method="post" action="<?php echo $_SESSION[$guid]['absoluteURL']."/modules/IB PYP/units_manage_working_editProcess.php?ibPYPUnitWorkingID=$ibPYPUnitWorkingID&gibbonSchoolYearID=$gibbonSchoolYearID" ?>">
					<table class='smallIntBorder' cellspacing='0' style="width: 100%;">
						...
						<tr class='break'>
							...
							<td colspan=2>
								<div class='linkTop'>
									<a href='<?php echo $_SESSION[$guid]['absoluteURL'] ?>/index.php?q=/modules/IB PYP/units_manage_working_edit.php&ibPYPUnitWorkingID=<?php echo $ibPYPUnitWorkingID ?>&step=1&gibbonSchoolYearID=<?php echo $gibbonSchoolYearID ?>'>Back to Planning</a>
								</div>
