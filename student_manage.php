...
if (isActionAccessible($guid, $connection2, "/modules/IB PYP/student_manage.php")==FALSE) {
	...
	print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/IB PYP/student_manage_add.php'><img title='New' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/page_new.gif'/></a>" ;
	print "</div>" ;
